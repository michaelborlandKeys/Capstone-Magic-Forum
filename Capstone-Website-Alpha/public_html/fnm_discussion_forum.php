...
<head>
	<meta charset="UTF-8">
	<title>FNM Discussion Forum</title>
...
<div id="FNM_description">
	...
	<button  class="btn btn-lg" type="button"  id="description_Button_V_5">View Site Description</button>  
	</div>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="form-group">
						...
						<form action="fnm_post_process.php"  autocomplete="off" method="post" >
							...
							<button type="submit" class="btn btn-group closeButtonColor" id="post_to_site">Post</button>
											...
											<div class="post_section">
												<div class="latest_posts">
													...
													<?php include("../resources/display_posts_fnm.php"); ?>
												</div>
											</div>
