...
<head>
	<meta charset="UTF-8">
	<title>Standard Discussion Forum</title>
...
<div id="standard_description">

</div>

<div class="description_section"> 
<button  class="btn btn-lg" type="button"  id="description_Button_V_8">View Site Description</button>
</div>
...
<div class="modal-dialog modal-lg">
	<div class="modal-content">
		...
		<div class="form-group">
			...
			<form action="standard_post_process.php"  autocomplete="off" method="post" >
