...
function description_V_2(event)
{
  ...
  "New Players welcome on all pages. Site moderation guidlines to be posted later. I want this to be a place where people can openly and constructively discuss all popular formats. I want this to be a place for players to come for advice on deck construction, and general Magic discussion.";
...
{
  var appendString_V_9 = "Welcome to the discussion board for The Modern Format,come here to discuss what's  going on, talk with friends in an open forum setting. This sites goal is connect magic players, and build a geniune community,"+
"New Players welcome on all pages. Site moderation guidlines to be posted later. I want this to be a place where people can openly and constructively discuss all popular formats. I want this to be a place for players to come for advice on deck construction, and general Magic discussion.";
...
{
  var appendString_V_10 = "Welcome to the discussion board for The Legacy Format,come here to discuss what's  going on, talk with friends in an open forum setting. This sites goal is connect magic players, and build a geniune community,"+
"New Players welcome on all pages. Site moderation guidlines to be posted later. I want this to be a place where people can openly and constructively discuss all popular formats. I want this to be a place for players to come for advice on deck construction, and general Magic discussion.";
  if($("#legacy_description").is(":hidden"))  {
   $("#legacy_description").show();  
    $("#legacy_description").append("<p>"+appendString_V_10+"</p>"); 
}
...
{
  var appendString_V_11 = "Welcome to the discussion board for The Magic Online Platform,come here to discuss what's  going on, talk with friends in an open forum setting. This sites goal is connect magic players, and build a geniune community,"+
"New Players welcome on all pages. Site moderation guidlines to be posted later. I want this to be a place where people can openly and constructively discuss all popular formats. I want this to be a place for players to come for advice on deck construction, and general Magic discussion.";
  if($("#MTGO_description").is(":hidden"))  {
   $("#MTGO_description").show();  
    $("#MTGO_description").append("<p>"+appendString_V_11+"</p>"); 
}
