...
$post_query = "SELECT * FROM capstone_format_home_posts";
...
if ($query_result->num_rows > 0) {
    ...
    while($forum_post = $query_result->fetch_assoc()) {
        echo " ".$forum_post_id." " .$forum_post['user_post_ID']. " ".$post_by_line." ". $post_username_temp. " ". $forum_post['user_format_post']." ".$date_time." ". $forum_post['user_time_format']."<br />";
