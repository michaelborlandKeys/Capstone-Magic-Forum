...
<head>
	<meta charset="UTF-8">
	<title>PPTQ Discussion Forum</title>
...
<body>
	...
	<div id="PPTQ_description">
			...
			<button  class="btn btn-lg" type="button"  id="description_Button_V_2">View Site Description</button> 
			</div>
					...
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							...
							<div class="form-group">
								...
								<form action="pptq_post_process.php"  autocomplete="off" method="post" >
