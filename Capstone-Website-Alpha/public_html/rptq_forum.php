...
<head>
	<meta charset="UTF-8">
	<title>RPTQ Discussion Forum</title>
...
<button  class="btn btn-lg" type="button"  id="description_V_4">View Site Description</button> 
</div>
...
<div class="modal-dialog modal-lg">
	<div class="modal-content">
		...
		<div class="form-group">
			...
			<form action="rptq_post_process.php"  autocomplete="off" method="post" >
